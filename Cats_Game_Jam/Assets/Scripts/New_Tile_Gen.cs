...
{
    public bool generatedTile = false;
    ...
    private void Start()
    {
        ...
        if (tm.tile_locations.Contains(location))
        {
            generatedTile = true;
        }
    }
    ...
    {
        if (!generatedTile && !tm.tile_locations.Contains(location) && collision.gameObject.tag.Equals("Player"))
        {
